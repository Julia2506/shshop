...
$template = [
    ...
    if(isset($_POST['edit']) && ($_POST['edit']) == 'yes') {
        ...
        $sql_add = "INSERT INTO products (id, name, sku, price, description, img_src) VALUES (
            NULL, 
            '{$_POST['name']}',
            '{$_POST['sku']}',
            {$_POST['price']},
        ...
        if($file_load) {
            $sql_add .=" , '/images/products/{$_FILES['photo']['name']}')";
        } else {
        $sql_add .=" , NULL)";
        }
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <input type="hidden" name="edit" value="yes">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="price" placeholder="Цена (руб.)">
                                </div>
                                <div class="form-group">
